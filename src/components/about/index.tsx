		...
		<div>
			...
			<div>
				...
				<p>
					...
					<span className='text-nosferatu-500'>Typescript</span>,{' '}
					<span className='text-nosferatu-500'>Python</span>,{' '}
					<span className='text-nosferatu-500'>Java</span> e{' '}
					<span className='text-nosferatu-500'>Go</span>, alem disso sou aberto
					a novos conhecimentos e experiencias.
				</p>
			</div>
		</div>
	);
